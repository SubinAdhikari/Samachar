...
<?php foreach($bannerNews as $key){ ?>
	<div class="container" style="background-color: GhostWhite;">
				...
				<h2 style="color:black;font-size:40px;"><strong><center>
					<a href="newsDetail.php?ref=<?php echo $key['news_id'];?>"><?php echo $key['news_title']; ?></center></strong></h2>
				</div>
				<div>
				<span style="color:black;font-size:20px;"><strong><center><?php echo $key['news_writtenby']; ?></center></strong></span>
				</div>
				<figure> <img width="100%" height="581" src="../backend/newsFeaturedImage/<?php echo $key['news_featuredimage']; ?>" href="newsDetail.php?ref=<?php echo $key['news_id'];?>"> </figure> 
				<p>
				<strong>
				<?php
                ...
                echo $subStrNews;
                ?>
                <a href="newsDetail.php?ref=<?php echo $key['news_id'];?>"><?php echo 'Read more';
                ?>
				 </strong></p>
